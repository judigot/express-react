...
function App() {
    ...
    const [arrayOfObjectsTransformation, setArrayOfObjectsTransformation] = useState('');
    ...
    useEffect(() => {
        ...
        setJSONSchemaTransformation(generateInterface({
            interfaceName: 'JSONSchema',
            data: jsonSchema,
            isDateStringFormat: true,
        }));
        setArrayOfObjectsTransformation(generateInterface({
            interfaceName: 'arrayOfObjects',
            data: arrayOfObjectsVariable,
            isDateStringFormat: true,
        }));
        setObjectTransformation(generateInterface({
            interfaceName: 'Object',
            data: objectVariable,
            isDateStringFormat: true,
        }));
        setSampleData(generateInterface({
    ...
    return (_jsxs("div", { style: {
            zoom: '50%',
            textAlign: 'center',
        }, children: [_jsx("h4", { children: "jsonSchema result:" }), _jsx("code", { children: JSONSchemaTransformation }), _jsx("br", {}), _jsx("br", {}), _jsx("h4", { children: "arrayOfObjects result:" }), _jsx("code", { children: arrayOfObjectsTransformation }), _jsx("br", {}), _jsx("br", {}), _jsx("h4", { children: "object result:" }), _jsx("code", { children: objectTransformation }), _jsx("br", {}), _jsx("br", {}), _jsx("h4", { children: "sampleData result:" }), _jsx("code", { children: sampleData }), _jsx("br", {}), _jsx("br", {})] }));
}
export default App;
