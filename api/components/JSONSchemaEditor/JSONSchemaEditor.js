...
function JSONSchemaEditor() {
    ...
    const handleSchemaChange = (e) => {
        ...
        if (isTableNameEdited && newWord) {
            ...
            const renamedSchema = Object.fromEntries(Object.entries(oldSchema).map(([key, value]) => [
