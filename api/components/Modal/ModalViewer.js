...
function ModalViewer() {
    ...
    return (_jsxs("div", { className: "p-4", children: [_jsx("button", { onClick: () => {
                    void (async () => {
                        await handleOpenModal();
                    })();
                }, className: "px-4 py-2 bg-green-600 text-white rounded-lg", children: "Open a random modal" }), _jsx(ModalProvider, {})] }));
}
