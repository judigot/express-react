...
export const setupTypeMappings = () => {
    const typeMappingsFilePath = join(process.cwd(), 'src', 'files', 'Constants', 'typeMappings.yaml');
    ...
    const dbTypesFilePath = join(process.cwd(), 'src', 'files', 'Constants', 'dbTypes.yaml');
