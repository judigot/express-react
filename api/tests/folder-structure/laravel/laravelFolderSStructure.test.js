...
describe('Laravel Folder Structure', () => {
    it('Should generate proper folder structure for one-to-one schema', () => {
        ...
        expect(normalizeWhitespace(usersPostOneToOneFolderStructure.join(''))).toStrictEqual(normalizeWhitespace(oneToOneExpectation.join('')));
    });
    it('Should generate proper folder structure for one-to-many schema', () => {
        ...
        expect(normalizeWhitespace(usersPostOneToManyFolderStructure.join(''))).toStrictEqual(normalizeWhitespace(oneToManyExpectation.join('')));
    });
    it('Should generate proper folder structure for many-to-many schema', () => {
        ...
        expect(normalizeWhitespace(usersPostOneToOneFolderStructure.join(''))).toStrictEqual(normalizeWhitespace(manyToManyExpectation.join('')));
    });
});
