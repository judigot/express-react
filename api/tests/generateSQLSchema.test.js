...
import { setupTypeMappings, teardownTypeMappings, } from '../tests/helpers/setupTypeMappings';
describe('generateSQLSchema', () => {
    ...
    it('should generate correct SQL schema for one-to-one relationship', () => {
        ...
        if (APP_SETTINGS.onDeleteCascade) {
            expect(sqlSchema).toContain('CONSTRAINT "FK_post_user_id" FOREIGN KEY ("user_id") REFERENCES "user" ("user_id") ON DELETE CASCADE');
        }
        else {
            expect(sqlSchema).toContain('CONSTRAINT "FK_post_user_id" FOREIGN KEY ("user_id") REFERENCES "user" ("user_id")');
        }
    });
    ...
    it('should generate correct SQL schema for POS', () => {
        ...
        expect(sqlSchema).toContain('CONSTRAINT "FK_order_customer_id" FOREIGN KEY ("customer_id") REFERENCES "customer" ("customer_id")');
        ...
        expect(sqlSchema).toContain('CONSTRAINT "FK_order_product_order_id" FOREIGN KEY ("order_id") REFERENCES "order" ("order_id")');
        expect(sqlSchema).toContain('CONSTRAINT "FK_order_product_product_id" FOREIGN KEY ("product_id") REFERENCES "product" ("product_id")');
    });
});
