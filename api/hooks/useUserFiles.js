...
const fetchGitHubFiles = async (params) => {
    ...
    try {
        ...
        if (!response.ok) {
            ...
            const isErrorResponse = (val) => typeof val === 'object' && val !== null && 'message' in val;
        ...
        if (error instanceof Error) {
            if (error.message === 'invalid zip data') {
                throw new Error('The repository either does not exist, is not public, or lacks a valid file structure. See documentation for details.');
            }
