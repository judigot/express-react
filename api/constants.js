...
export const frameworkDirectories = {
    spring_boot: {
        ...
        controller: 'src/main/java/com/example/demo/controller/user_controller.java',
        repository: 'src/main/java/com/example/demo/repository/user_repository.java',
        ...
        exception: 'src/main/java/com/example/demo/exception/global_exception_handler.java',
    },
    laravel: {
        routes: 'routes/api.php',
