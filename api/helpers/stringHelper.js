...
export const replacePlaceholder = ({ template, replacements, }) => Object.entries(replacements).reduce((result, [key, value]) => result.replace(new RegExp(`{{${key}}}`, 'g'), value), template);
