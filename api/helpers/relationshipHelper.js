export const addRelationship = (schemaInfo, sourceTableName, relationshipType, targetTableName) => {
...
export const purgeForeignKeyTraces = (schemaInfo) => {
    ...
    return schemaInfo.map((table) => {
        ...
        const removedColumnNames = new Set(table.columnsInfo
        ...
        updatedTable.foreignTables = filterArray(table.foreignTables, (t) => existingTableNames.has(t));
        updatedTable.foreignKeys = filterArray(table.foreignKeys, (k) => !removedColumnNames.has(k));
        updatedTable.childTables = filterArray(table.childTables, (t) => existingTableNames.has(t));
        updatedTable.hasOne = filterArray(table.hasOne, (t) => existingTableNames.has(t));
        updatedTable.hasMany = filterArray(table.hasMany, (t) => existingTableNames.has(t));
        updatedTable.belongsTo = filterArray(table.belongsTo, (t) => existingTableNames.has(t));
        updatedTable.belongsToMany = filterArray(table.belongsToMany, (t) => existingTableNames.has(t));
        // Clean up requiredColumns
        if (table.requiredColumns?.length != null) {
            const requiredColumns = table.requiredColumns.filter((col) => !removedColumnNames.has(col));
        ...
        if (table.pivotRelationships?.length != null) {
            const filteredPivotRelationships = table.pivotRelationships.filter((rel) => existingTableNames.has(rel.relatedTable) &&
