...
if (rootElement) {
    ReactDOM.createRoot(rootElement).render(_jsx(React.StrictMode, { children: _jsx(Auth0Provider, { domain: String(import.meta.env.VITE_AUTH0_DOMAIN), clientId: String(import.meta.env.VITE_AUTH0_CLIENT_ID), authorizationParams: {
                redirect_uri: window.location.origin,
                audience: String(import.meta.env.VITE_AUTH0_AUDIENCE),
                scope: 'openid profile email offline_access',
            }, cacheLocation: "localstorage", useRefreshTokens: true, children: _jsx(QueryClientProvider, { client: queryClient, children: _jsxs(AuthGuard, { children: [_jsx(ModalProvider, {}), _jsx(SQLSchemaInputModal, {}), _jsx(App, {})] }) }) }) }));
}
