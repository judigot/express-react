...
import { RECURSIVE_WILDCARD_REGEX, FOLDER_PATH_REGEX, } from '../../../utils/project-builder/constants/templateActions';
 ...
 */
export const createBaseMethodFile = (command, userFiles, projectYamlPath, _schemaInfo, schemaInfoParsed, table) => {
    ...
    if (recursiveWildcardMatch) {
        ...
        if (matchingFolders.length === 0) {
            ...
            const foldersWithTemplateFiles = allFolders.filter((folder) => {
                const hasTemplateFile = folder.children.some((child) => child.type === 'file' &&
