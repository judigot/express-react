 ...
 */
export const replacePlaceholders = (text, replacements, userFiles, schemaInfoParsed, table, projectFilePath, templateFilePath, formData, userMetadata) => {
    // Process all commands
    const processedText = processCommand(text, userFiles, schemaInfoParsed, table, templateFilePath, projectFilePath, formData, userMetadata);
    ...
    try {
        const processedPlaceholders = importTemplateAsPlaceholder(processedConditions, replacements);
