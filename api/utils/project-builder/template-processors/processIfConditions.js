export const processIfConditions = (content, replacements) => {
    ...
    content = content.replace(simpleIfPattern, (_match, variableName, value, ifContent) => {
    ...
    content = content.replace(complexEqualsPattern, (_match, variableName, value, ifContent) => {
        // Check if the variable exists
        if (!(variableName in replacements)) {
            return '';
        }
    ...
    content = content.replace(notEqualsPattern, (_match, variableName, value, ifContent) => {
        // Check if the variable exists
        if (!(variableName in replacements)) {
            return '';
        }
    ...
    content = content.replace(elsePattern, (_match, variableName, value, ifContent, elseContent) => {
        // Check if the variable exists
        if (!(variableName in replacements)) {
