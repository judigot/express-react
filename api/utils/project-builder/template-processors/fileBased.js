...
export const processFileBasedTemplate = (folderPath, userFiles, schemaInfoParsed, table, template, includedFiles = [], excludedFiles = [], separator = '\n', projectFilePath, formData, userMetadata) => {
    ...
    currentFolder.children.forEach((item) => {
        if (item.type === 'folder') {
            ...
            const shouldExclude = excludedFiles.some((pattern) => item.name.includes(pattern));
            ...
            try {
                ...
                const processedTemplate = replacePlaceholders(template, replacements, userFiles, schemaInfoParsed, table, projectFilePath, folderPath, formData, userMetadata);
