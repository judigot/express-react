import { changeCase, generateColumnDefinition, getTypeMapping, } from '../utils/common';
...
`;
    ...
    schemaInfo.forEach(({ tableName, columnsInfo }) => {
        ...
        return (filesContent[`I${className}`] = generateInterfaceContent(className, columnsInfo));
    });
    return filesContent;
};
