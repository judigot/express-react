...
export const isSchemaInfoAlreadySorted = (schemaInfo) => {
    return schemaInfo.every((relationship, i) => relationship.childTables == null ||
        relationship.childTables.every((childTable) => schemaInfo.findIndex((r) => r.tableName === childTable) > i));
};
