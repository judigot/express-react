...
export const createLocalFilesService = async (data) => {
    ...
    if (typeof formData.projectName === 'string' &&
    ...
    try {
        ...
        const response = await fetch(isUsingLocalFiles
        ...
        // Build project files
        const projectFiles = buildProjectFiles(`/Projects/${projectName}/structure.yaml`, userFiles, schemaInfo, formData);
