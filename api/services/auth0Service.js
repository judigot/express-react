...
function getManagementClient() {
    if (managementClient === null) {
        ...
        if (!config) {
            throw new Error('Auth0 Management API credentials are missing. Please set AUTH0_DOMAIN, AUTH0_MANAGEMENT_API_CLIENT_ID, and AUTH0_MANAGEMENT_API_CLIENT_SECRET environment variables.');
        }
