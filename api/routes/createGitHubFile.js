...
router.post('/create-github-file', (req, res) => {
    void (async () => {
        try {
            ...
            const auth0UserId = 'auth0UserId' in req && typeof req.auth0UserId === 'string'
                ? req.auth0UserId
                : undefined;
            ...
            if (typeof publicRepoURL !== 'string' ||
                publicRepoURL === '' ||
            ...
            if (githubToken === null || githubToken === '') {
                res.status(400).json({
                    ...
                    message: 'Please set your GitHub token in the settings before creating files',
                });
                return;
            }
