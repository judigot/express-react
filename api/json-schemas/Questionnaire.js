export default {
    question_type: [
        ...
        },
        {
            ...
            description: 'Students indicate whether a given statement is true or false.',
        },
        {
            question_type_id: 3,
            type_name: 'fill_in_the_blanks',
            description: 'Students fill in missing words or phrases in a sentence or passage.',
        },
        {
            question_type_id: 4,
        ...
        },
        {
            question_type_id: 5,
            type_name: 'essay',
            description: 'Students write longer, more detailed responses, often involving analysis, explanation, or opinion.',
        },
        {
            question_type_id: 6,
            type_name: 'matching',
            description: 'Students match items from two lists, such as terms and their definitions, by drawing lines or writing corresponding letters/numbers.',
        },
        {
            question_type_id: 7,
            type_name: 'cloze_test',
            description: 'A type of fill-in-the-blank test where students complete a passage with missing words based on context.',
        },
        {
            question_type_id: 8,
            type_name: 'labeling_diagram',
            description: 'Students write the correct terms to label parts of a diagram, such as in biology, geography, or physics.',
        },
        {
            question_type_id: 9,
            type_name: 'ordering',
            description: 'Students write or arrange events, steps, or concepts in a logical order, such as chronological events in history or steps in a process.',
        },
        {
            question_type_id: 10,
            type_name: 'problem_solving',
            description: 'Students solve mathematical, scientific, or logical problems, showing their calculations and reasoning in writing.',
        },
        {
            question_type_id: 11,
            type_name: 'open_ended',
            description: 'Students answer questions with more flexibility, allowing for various valid responses based on understanding.',
        },
        {
            question_type_id: 12,
            type_name: 'source_based',
            description: 'Students respond to questions by analyzing a given source, such as a text, graph, or image.',
        },
    ],
    question: [
        {
        ...
        {
            question_id: 7,
            question_text: 'Complete the sentence: The Earth revolves around the _______.',
            question_type_id: 7,
        },
        {
            question_id: 8,
        ...
        {
            question_id: 10,
            question_text: 'If a car travels 60 kilometers in 2 hours, how fast is the car traveling?',
            question_type_id: 10,
        },
        {
            question_id: 11,
            question_text: 'Describe one way in which recycling benefits the environment.',
            question_type_id: 11,
        },
        {
            question_id: 12,
            question_text: 'Analyze the chart showing the number of endangered species over time. Identify the year with the largest increase.',
            question_type_id: 12,
        },
    ],
    ...
    essay_answer: [
        {
            essay_answer_id: 1,
            question_id: 5,
            correct_answer: 'Photosynthesis is the process by which plants use sunlight, carbon dioxide, and water to produce food and oxygen.',
        },
    ],
    matching_pair: [
        {
    ...
    open_ended_answer: [
        {
            ...
            question_id: 11,
            answer_text: 'Recycling helps reduce waste, conserve natural resources, and decrease pollution.',
        },
    ],
